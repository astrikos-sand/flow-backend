def func(preprocessing_dict, df):
    ...
    for step, parameters in preprocessing_dict.items():
        ...
        if step == "mean_imputation":
            ...
            categorical_info = preprocessing_dict.get("iterative_imputation", {}).get(
                "categorical", None
            )
            ...
            if categorical_info:
                ...
                for col in categorical_columns:
                    ...
                    indices_to_remove = [
                        ...
                        if (isinstance(x, (int, float)) and np.isnan(x)) or x is None
                    ]
                    values_to_add_back = [
                        x
                        for x in col_values
...
predicted_df = func(preprocessing_dict, df)
