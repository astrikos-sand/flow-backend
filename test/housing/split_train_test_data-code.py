def func(undersample_df, oversampling):
    # Implement your logic here
    def split_train_test_data(df, target, X_variables=None, test_size=0.2, random_state=None, sampling=None, type=None):
        ...
        if type == 'classification':
            if sampling == 'undersampling':
                ...
                X_train, X_test, y_train, y_test = train_test_split(X_undersampled, y_undersampled, test_size=test_size, random_state=random_state)
                ...
                try:
                    ...
                    X_train_oversampled, y_train_oversampled = oversampling(train_df_full, target, random_state=random_state)
                    return X_train_oversampled, X_test, y_train_oversampled, y_test
                except ValueError as e:
                    print("Samples in minority class are too few to oversample. Continueing with the train-test split ")
...
split_train_test_data = func(undersample_df, oversampling)