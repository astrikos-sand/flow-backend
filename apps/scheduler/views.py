...
from apps.scheduler.serializers import (
    WebHookScheduleSerializer,
    PeriodicScheduleSerializer,
)
...
router.register(
    r"webhook-schedulers", WebHookSchedulerViewSet, basename="webhook-scheduler"
)
router.register(
    r"periodic-schedulers", PeriodicScheduleViewSet, basename="periodic-scheduler"
)
