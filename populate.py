...
function_misc_prefix = Prefix.objects.get(
    name="miscellaneous", parent=function_root_prefix
)

dependency_root_prefix = Prefix.objects.get(
    name=ITEM_TYPE.DEPENDENCY.value, parent=None
)
dependency_misc_prefix = Prefix.objects.get(
    name="miscellaneous", parent=dependency_root_prefix
)

file_archive_root_prefix = Prefix.objects.get(
    name=ITEM_TYPE.ARCHIVES.value, parent=None
)
file_archive_misc_prefix = Prefix.objects.get(
    name="miscellaneous", parent=file_archive_root_prefix
)
